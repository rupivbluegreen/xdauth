...
require (
	...
	github.com/go-chi/chi/v5 v5.2.4 // router named allowed by the MVP spec
	github.com/golang-jwt/jwt/v5 v5.2.2 // test-only: signs ID tokens for the fake OIDC provider in integration_test.go
	github.com/stretchr/testify v1.10.0 // test assertion library named allowed by the MVP spec
	golang.org/x/crypto v0.52.0 // cmd/xdauth-sshd: keyboard-interactive SSH server example (golang.org/x/crypto/ssh)
